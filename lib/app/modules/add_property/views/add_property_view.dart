...
import 'package:rent_app/app/modules/add_property/components/property_seller.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            PropertyPrice(controller: controller),
            SizedBox(height:10),
            const Padding(
              padding: EdgeInsets.only(left: 20.0, top: 10),
              child: Text(
            ...
            PropertySellerField(controller: controller),
            SizedBox(height:10),
            const Padding(
